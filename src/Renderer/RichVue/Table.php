...
class Kint_Renderer_RichVue_Table extends Kint_Renderer_RichVue_Plugin
{
            ...
            foreach ($row->value->contents as $field) {
                ...
                switch ($field->type) {
                    ...
                    case 'string':
                        ...
                        if (Kint_Renderer_RichVue::$strlen_max && self::$respect_str_length && Kint_Object_Blob::strlen($val) > Kint_Renderer_RichVue::$strlen_max) {
                            $val = substr($val, 0, Kint_Renderer_RichVue::$strlen_max).'...';
                        }
