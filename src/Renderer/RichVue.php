...
class Kint_Renderer_RichVue extends Kint_Renderer
{
    public static $object_renderers = array(
        'blacklist' => 'Kint_Renderer_RichVue_Blacklist',
        'callable' => 'Kint_Renderer_RichVue_Callable',
        'closure' => 'Kint_Renderer_RichVue_Closure',
        'color' => 'Kint_Renderer_RichVue_Color',
        'depth_limit' => 'Kint_Renderer_RichVue_DepthLimit',
        'nothing' => 'Kint_Renderer_RichVue_Nothing',
        'recursion' => 'Kint_Renderer_RichVue_Recursion',
        'simplexml_element' => 'Kint_Renderer_RichVue_SimpleXMLElement',
        'trace_frame' => 'Kint_Renderer_RichVue_TraceFrame',
    );
    public static $tab_renderers = array(
        'binary' => 'Kint_Renderer_RichVue_Binary',
        'color' => 'Kint_Renderer_RichVue_ColorDetails',
        'docstring' => 'Kint_Renderer_RichVue_Docstring',
        'microtime' => 'Kint_Renderer_RichVue_Microtime',
        'source' => 'Kint_Renderer_RichVue_Source',
        'table' => 'Kint_Renderer_RichVue_Table',
        'timestamp' => 'Kint_Renderer_RichVue_Timestamp',
    );
    public static $pre_render_sources = array(
        'script' => array(
            array('Kint_Renderer_RichVue', 'renderJs'),
            array('Kint_Renderer_RichVue_Microtime', 'renderJs'),
        ),
        'style' => array(
            array('Kint_Renderer_RichVue', 'renderCss'),
        ),
        'raw' => array(),
    );
